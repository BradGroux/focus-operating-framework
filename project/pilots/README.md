...
- work, personal, or combined life scope;
- practice path and moves used;
- usefulness, restart effect, and net-burden measures;
- privacy, sharing, overwrite, action, and authority outcomes;
- aggregate coverage and stop-condition counts; and
- sanitized findings and steward disposition.

Do not publish source content, Journal text, Check-In text, names, employers,
...
An episode counts toward the minimum only when it records:

- a usefulness rating from 1 to 5;
- whether restart effort was lower, unchanged, higher, or not applicable;
- whether review and correction burden was lower than, equal to, or higher than
  the time, confusion, or risk removed;
- whether provenance and authority were preserved when applicable; and
- whether any material privacy, accidental-sharing, silent-overwrite, or
  unauthorized-action failure occurred.

An episode with missing required measures does not count.
